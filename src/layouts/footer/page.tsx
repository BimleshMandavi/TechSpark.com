    ...
    <div className=" bg-[#1B1B1B]  text-white  h-[111px] sm:h-[469px] w-full text-center lg:pt-5 mt-auto">
      ...
      >
        <div className="flex justify-between md:hidden px-2  top-[6842px] left-[1px]">
          <div
            className={
              `${pathname === "/about" ? "border-t-2 border-red-500" : ""}` +
              "flex flex-col justify-center items-center gap-4 text-center pb-2"
            }
          >
            <Link
          ...
          <div
            className={
              `${pathname === "/blog" ? "border-t-2 border-red-500" : ""}` +
              "flex flex-col justify-center items-center gap-4 text-center pb-2"
            }
          >
            <Link
          ...
          <div
            className={
              `${pathname === "/" ? "border-t-2 border-red-500" : ""}` +
              "flex flex-col justify-center items-center gap-4 text-center pb-2"
            }
          >
            <Link
          ...
          <div
            className={
              `${pathname === "/carrier" ? "border-t-2 border-red-500" : ""}` +
              "flex flex-col justify-center items-center gap-4 text-center pb-2"
            }
          >
            <Link
          ...
          <div
            className={
              `${pathname === "/contact" ? "border-t-2 border-red-500" : ""}` +
              "flex flex-col justify-center items-center gap-4 text-center pb-2"
            }
          >
            <Link
      ...
      <div className="hidden md:flex flex-col gap-[40px] flex-wrap w-screen mb-0">
        <div className="md:flex  h-[276px] md:justify-between items-center px-10 pt-1 flex-wrap">
          <div className="flex flex-col gap-4 flex-wrap">
            <Image
              ...
              priority
            />
            <p className="w-[419px] text-[18px] text-start">
              Make Your Business Online <span className=" rounded-full text-green-500"></span>
            </p>
          ...
          <div className="flex flex-col gap-3 flex-wrap">
            ...
            <Link
              href="/about"
              className="hover:text-sky-400 hover:shadow-md hover:shadow-sky-400 transition-all duration-300"
            >
              About Us
            </Link>
            <Link
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link href="/carrier" className="hover:text-sky-400">
          ...
          <div className="flex flex-col justify-between items-start gap-5 flex-wrap">
            ...
            <div className="flex flex-col items-start">
              <input
                className="w-[342px] sm:w-full h-[54px] hover:border-orange-400 p-4 text-black cursor-pointer rounded-sm"
                type="email"
                placeholder="Type email hare..."
              />
            </div>
        ...
        <div className="flex justify-evenly items-center pt-10">
          <div>
            <h1>© All rights reserved – The TechSpark IT Solutions.</h1>
          </div>
